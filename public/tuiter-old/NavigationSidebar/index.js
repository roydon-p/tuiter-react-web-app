const NavigationSidebar = () => {
   ...
   <div class="list-group">
     ...
     <a href="../HomeScreen-old/index.html" class="list-group-item list-group-item-action">
         <div>
             <span><i class="fas fa-home float-start pt-1"></i></span>
             <span class="d-none d-xl-block ps-4">Home</span>
         </div>
     </a>
     <a href="../explore-old/index.html" class="list-group-item list-group-item-action active">
         <div>
